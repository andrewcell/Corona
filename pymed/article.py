...
class PubMedArticle(object):
    ...
    def _extractJournalIssue(self: object, xml_element: TypeVar("Element")) -> list:
        return {
                "ISOName": getContent(element=xml_element, path=".//Journal/ISOAbbreviation", default=None),
                "Volume": getContent(element=xml_element, path=".//Journal/JournalIssue/Volume", default=None),
                "Issue":  getContent(element=xml_element, path=".//Journal/JournalIssue/Issue", default=None),
                "PubDate_Year":  getContent(element=xml_element, path=".//Journal/JournalIssue/PubDate/Year", default=None),
                "PubDate_Month": getContent(element=xml_element, path=".//Journal/JournalIssue/PubDate/Month", default=None),
                "Page": getContent(element=xml_element, path=".//Pagination/MedlinePgn", default=None),
        }
    ...
    def _initializeFromXML(self: object, xml_element: TypeVar("Element")) -> None:
        ...
        self.journalissue = self._extractJournalIssue(xml_element)
